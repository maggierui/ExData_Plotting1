...
plot(dat_1$DateTime,dat$Voltage,type="l",xlab="datetime", ylab="Voltage")
plot(dat_1$DateTime,dat_1$Sub_metering_1,type="n",xlab=NA,ylab="Energy sub metering",col="black")
lines(dat_1$DateTime,dat_1$Sub_metering_1,lty=1)
lines(dat_1$DateTime,dat_1$Sub_metering_2,lty=1,col="red")
lines(dat_1$DateTime,dat_1$Sub_metering_3,lty=1,col="blue")
legend("topright",lty=c(1,1),col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
plot(dat_1$DateTime,dat$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()
